...
const SUB_PROMPTS: Record<string, string> = {
  ...
  PROFESSIONAL:
    'Rewrite in a clean, formal tone for work or school. No slang, no humor, just straight-to-the-point clarity. Example: Input: "Your work is sloppy." Output: "Your work needs more attention to detail and polish."',
